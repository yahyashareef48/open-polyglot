...
import { Play, Pause, SkipForward, SkipBack, Gauge, X, Minimize2, Maximize2 } from "lucide-react";
    ...
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      {!isMinimized && (
        <>
          ...
          >
            {isPlaying && !isPaused ? <Pause className="w-6 h-6 text-white fill-white" /> : <Play className="w-6 h-6 text-white fill-white" />}
          </button>
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{playbackSpeed}x</span>
            </button>
