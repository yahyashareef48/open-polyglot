...
export default function MarkCompleteButton({
  ...
  return (
    <button
      ...
      className="w-full py-4 px-6 bg-gradient-to-r from-red-600 to-yellow-400 text-white font-bold rounded-lg hover:from-red-700 hover:to-yellow-500 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg"
    >
      {isCompleting ? (
